...
ifeq ($(DO_CORDIEBOT), 3)            
SOURCEFILES +=  pubnublisten_subloop.cpp \
...
ifeq ($(DO_CORDIEBOT), 1)
cordiebot_pubnubpipe: subscribe_publish_callback.cpp \
	...
	$(CXX) -o $@ -ljsoncpp -D PUBNUB_CALLBACK_API $(CFLAGS) $(CFLAGS_CALLBACK) \
	             -x c++ subscribe_publish_callback.cpp \
